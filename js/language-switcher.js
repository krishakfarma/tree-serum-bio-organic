...
function updateProductsSection() {
  ...
  filterTabs.forEach(tab => {
    ...
    if (onclick.includes("'all'")) {
      tab.textContent = t('products.allProducts');
    } else if (onclick.includes("'sugarcane'")) {
      tab.textContent = t('categories.sugarcane');
    } else if (onclick.includes("'universal'")) {
      tab.textContent = t('categories.allCrops');
    } else if (onclick.includes("'special'")) {
      tab.textContent = t('categories.special');
    } else if (onclick.includes("'soil'")) {
      tab.textContent = t('categories.soil');
    }
  });
...
function updatePageMeta() {
  ...
  if (title) {
    if (currentLanguage === 'mr') {
      ...
      title.textContent = 'Tree Serum Bio Organic International | Bio-organic Agricultural Solutions';
    }
  }
  ...
  if (metaDescription) {
    if (currentLanguage === 'mr') {
      ...
      metaDescription.content = 'Tree Serum Bio Organic International offers certified bio-organic biostimulants and crop-specific solutions for sugarcane, vegetables, fruits, and all crops. ISO 9001:2015 certified quality products for better yields.';
    }
  }
