...
{ 
  name: { en: "Sugar Special Stage 1", mr: "ऊस विशेष टप्पा १" }, 
  image: "https://i.ibb.co/pB4z57H6/sugercane-special-stage-1.png", 
  tag: { en: "Sugarcane", mr: "ऊस" }, 
  category: "sugarcane", 
  dose: { en: "Drip: 5–10 L/acre", mr: "ड्रिप: ५-१० लिटर/एकर" },
  benefits: {
    en: ["Lush growth, dark color, massive branching", "Enhances strength & nutrient absorption", "Modern technology for sugarcane"],
    mr: ["जाडी वाढ, गडद रंग, मोठ्या फांगे", "शक्ती आणि पोषक तत्वांचे शोषण वाढवते", "ऊसांसाठी आधुनिक तंत्रज्ञान"]
  }, 
  crops: { en: "Sugarcane", mr: "ऊस" }
},
{ 
  name: { en: "Sugar Special Stage 2", mr: "ऊस विशेष टप्पा २" }, 
  ...
  benefits: {
    ...
    mr: ["लांबी आणि रुंदी पानांची वाढ, गडद रंग", "मोठ्या मुळांची वाढ, अन्न निर्मितीची गती", "ऊसांचे वजन वाढीसाठी चांगले"]
  }, 
  crops: { en: "Sugarcane", mr: "ऊस" }
},
{ 
  name: { en: "Sugar Special Stage 3", mr: "ऊस विशेष टप्पा ३" }, 
  ...
  benefits: {
    ...
    mr: ["अंतिम कापन टप्प्यातील ऊसांसाठी", "लांबी आणि जड पानांची वाढ, अत्यंत मुळांची वाढ", "उत्पादन १०-१५% वाढवते"]
  }, 
  crops: { en: "Sugarcane", mr: "ऊस" }
},
{ 
...
{ 
  name: { en: "Guava Special", mr: "पेरू विशेष" }, 
...
{ 
  ...
  { 
    name: { en: "Sugar Cane", mr: "ऊस स्प्रे" }, 
